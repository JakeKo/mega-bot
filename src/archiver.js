...
module.exports = (bot, store) => async () => {
    const localArchiveCounter = ++archiveCounter;
    console.log(`BEGIN ARCHIVE RUN ${localArchiveCounter}`);
    ...
    console.log(`END ARCHIVE RUN ${localArchiveCounter}`);
};
